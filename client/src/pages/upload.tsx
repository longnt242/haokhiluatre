...
export default function Upload() {
  const [contentType, setContentType] = useState<ContentType>("2DImage");
        ...
        <div className="max-w-2xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <p className="text-xl text-muted-foreground">
              Chia sẻ mô hình 3D, hình ảnh và video mới
            </p>
          </div>
            ...
            <CardContent className="p-8 text-center">
              <div className="space-y-4">
                ...
                <h3 className="text-xl font-semibold">
                  Tính năng upload đang được cấu hình
                </h3>
                <p className="text-muted-foreground">
                  Để sử dụng tính năng tải lên file, quản trị viên cần cấu hình
                  các biến môi trường Supabase.
                </p>
    ...
    <div className="min-h-screen bg-card py-20">
      <div className="max-w-2xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              <div>
                ...
                >
                  ...
                  <SelectContent>
                    <SelectItem value="2DImage">
                      <div className="flex items-center gap-2">
                        <Image className="w-4 h-4" /> Hình Ảnh 2D (PNG, JPG)
                      </div>
                    </SelectItem>
                    <SelectItem value="3DImage">
                      <div className="flex items-center gap-2">
                        <Image className="w-4 h-4" /> Hình Ảnh 3D (PNG, JPG)
                      </div>
                    </SelectItem>
        ...
        <div className="mt-8 text-center text-sm text-muted-foreground">
          <p>
            Bằng cách tải lên nội dung, bạn xác nhận rằng bạn có quyền sử dụng
            và chia sẻ tài liệu này.
          </p>
        </div>
      </div>
    </div>
